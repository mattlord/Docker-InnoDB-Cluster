...
docker run --rm --name=mysqlgr2 --hostname=mysqlgr2 --network=grnet -p 3392:3392 -e MYSQL_ROOT_PASSWORD=root -e GROUP_NAME="92bb4382-3bd1-11e7-a919-92ebcb67fe33" -e GROUP_SEEDS="mysqlgr1:6606" -itd mattalord/innodb-cluster
timeout 3 /NOBREAK

echo Adding a third node to the cluster ...
docker run --rm --name=mysqlgr3 --hostname=mysqlgr3 --network=grnet -p 3393:3393 -e MYSQL_ROOT_PASSWORD=root -e GROUP_NAME="92bb4382-3bd1-11e7-a919-92ebcb67fe33" -e GROUP_SEEDS="mysqlgr1:6606" -itd mattalord/innodb-cluster
timeout 3 /NOBREAK
